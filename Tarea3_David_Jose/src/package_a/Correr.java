...
class Abrir extends Thread {
	...
	// Añadimo como parametro el semaforo que usara el hilo	
	public Abrir(Semaphore semaforo){
		this.semaforo = semaforo;
	}
	
	public void run() {
		//Añadimos un sleep para obligar a que se ejecute el otro hilo primero
		try {
			sleep(10);
 ...
 * uitilizo un semaforo para poder asi sincronizar los 2 hilos, ademas de añadir sleep para
